...
class TasksTests(unittest.TestCase):
    ...
    def create_user(self, name, email, password):
        new_user = User(name=name, email=email, password=bcrypt.generate_password_hash
(password))
...
('allpowerful'),
    ...
    def create_task(self):
        return self.app.post('add/', data=dict(
            name='Go to the shopping mall',
            due_date='08/01/2016',
            priority='1',
            posted_date='07/31/2016',
    ...
    def test_users_can_add_tasks(self):
        self.create_user('Michael', 'miachel@realpython.com', 'python')
    ...
    def test_admin_users_can_complete_tasks_that_are_not_created_by_them(self):
        self.create_user('Michael', 'miachel@realpython.com', 'python101')
    ...
    def test_task_template_displays_logged_in_ser_name(self):
        self.register('Fletcher', 'fletcher@realpython.com', 'python101', 'python101')
        self.login('Fletcher', 'python101')
        response = self.app.get('tasks/', follow_redirects=True)
    ...
    def test_users_cannot_see_task_modify_links_for_tasks_not_created_by_them(self):
        ...
        self.login('Fletcher', 'python101')
        response = self.app.get('tasks/', follow_redirects=True)
        self.assertNotIn(b'Mask as complete', response.data)
